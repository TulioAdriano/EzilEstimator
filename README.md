...
### Machines
Enter a hostname to retrieve T-Rex statistics. If running on the same machine you can use localhost or 127.0.0.1. If running remote, make sure to add the `--api-bind-http` parameter to enable remote access. See the [T-Rex readme.md file](https://github.com/trexminer/T-Rex/blob/master/README.md) for details on how this parameter works.
